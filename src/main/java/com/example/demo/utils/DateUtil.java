...
public class DateUtil {
    ...
    public static Date getDlyDay(String day) {
        //取当前时间
        Date date = new Date();
        Calendar calendar = Calendar.getInstance();
        calendar.setTime(date);
...
//        Date d = dateFormat1.parse("2009-11-15");
//        System.out.println(formatDateToStr(d,"yyyy-M-d"));
//        System.out.println(formatDateToStr(d,"yyyy/M/d"));
        System.out.println(formatDateToStr(getDlyDay("36500"),"yyyy-MM-dd hh:mm:ss"));
