...
import com.example.demo.mybatis.model.UserExample.Criteria;
import com.example.demo.mybatis.model.UserExample.Criterion;
...
public class UserSqlProvider {
    ...
    public String insertSelective(User record) {
        ...
        if (record.getGander() != null) {
            sql.VALUES("gander", "#{gander,jdbcType=INTEGER}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getGander() != null) {
            sql.SET("gander = #{record.gander,jdbcType=INTEGER}");
        }
    ...
    public String updateByPrimaryKeySelective(User record) {
        ...
        if (record.getGander() != null) {
            sql.SET("gander = #{gander,jdbcType=INTEGER}");
        }
